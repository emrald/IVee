...
public class ObservableNestedScrollView implements Observer, NestedScrollView.OnScrollChangeListener {
    ...
    private void init() {
        if (mNestedScrollView instanceof com.androidtutorialpoint.horizontallistview.NestedScrollView) {
            ((com.androidtutorialpoint.horizontallistview.NestedScrollView) mNestedScrollView).addOnScrollListener(this);
        } else {
