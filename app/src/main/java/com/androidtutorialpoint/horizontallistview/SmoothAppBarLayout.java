...
public class SmoothAppBarLayout extends AppBarLayout {
  ...
  private com.androidtutorialpoint.horizontallistview.OnOffsetChangedListener mSyncOffsetListener;
  ...
  private void setSyncOffsetListener(com.androidtutorialpoint.horizontallistview.OnOffsetChangedListener syncOffsetListener) {
  ...
  public static class Behavior extends BaseBehavior {
    ...
    protected void onInit(CoordinatorLayout coordinatorLayout, final AppBarLayout child) {
      ...
      if (child instanceof SmoothAppBarLayout) {
        ...
        layout.setSyncOffsetListener(new com.androidtutorialpoint.horizontallistview.OnOffsetChangedListener() {
          @Override
